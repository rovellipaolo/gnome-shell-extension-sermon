...
const ClickableSectionItemPresenter = imports.src.presentation.presenter.sectionItem.ClickableSectionItemPresenter;
...
function testSuite() {
    ...
    describe("ClickableSectionItemPresenter()", () => {
        viewMock.reset();
        const sut = new ClickableSectionItemPresenter(viewMock, { id: ANY_ID, labelText: ANY_LABEL_TEXT });
